          ...
          <div className="banner_inner d-flex align-items-center">
            <div className="row">
                <div className={`${pageBanner.banner_content}`}>
                  <h3 className="text-center">FIRST Robotics Competition</h3>
                  <p className="text-center">Combining the excitement of sport with the rigors of science and technology</p>
                </div>
            </div>
          </div>
        </div>
